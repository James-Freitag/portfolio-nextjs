  ...
  return (
    ...
    >
      <div className="w-[65%] py-3 px-4">
        <h3 className="text-3xl text-sky-400  p-2">- Projects -</h3>
        <div className="flex justify-center items-center pb-12">
          <div className="grid w-3/4 grid-cols-1 md:grid-cols-3 md:pt-16 gap-4">
            <motion.div
            ...
            >
              <p>Project 1</p>
              <div className="h-[145px] w-full px-4 bg-blue-500 rounded-lg"></div>
            ...
            >
              <p>Project 2</p>
              <div className="h-[145px] w-full px-4 bg-blue-700 rounded-lg"></div>
            ...
            <motion.div
              ...
              whileHover={{ scale: 1.02 }}
              transition={{ type: "spring", stiffness: 400, damping: 18 }}
              className="w-full h-auto py-3 px-4 md:row-start-2 rounded-lg bg-neutral-950 border-[1px] border-gray-400"
            >
              <p>Project 3</p>
              <div className="h-[145px] w-full px-4 bg-blue-300 rounded-lg"></div>
            ...
            <motion.div
              ...
              whileHover={{ scale: 1.02 }}
              transition={{ type: "spring", stiffness: 400, damping: 18 }}
              className="w-full h-auto py-3 px-4 md:col-span-2 bg-neutral-950 rounded-lg border-[1px] border-gray-400"
            >
              <p>Project 4</p>
              <div className="h-[145px] w-full px-4 bg-blue-900 rounded-lg"></div>
              <div className="flex justify-evenly items-center w-full pt-2 py-1">
                <button className="bg-neutral-800 rounded-lg px-2">
                  Source Code
                </button>
